...
// */
//final class Version20240913104045 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE appro_caisse ADD reference VARCHAR(255) DEFAULT NULL, ADD objet VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE appro_caisse DROP reference, DROP objet');
//    }
//}
