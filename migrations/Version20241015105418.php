 ...
 */
final class Version20241015105418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, fdb_id INT DEFAULT NULL, bonapprovisionnement_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, message VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', unread TINYINT(1) DEFAULT NULL, permission VARCHAR(255) DEFAULT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), INDEX IDX_BF5476CABF2BFC3 (fdb_id), INDEX IDX_BF5476CA1715AECD (bonapprovisionnement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT NULL, contact VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(255) DEFAULT NULL, fonction VARCHAR(255) DEFAULT NULL, is_temporary TINYINT(1) DEFAULT NULL, is_responsable TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
