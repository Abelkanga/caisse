 ...
 */
final class Version20240902081627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billetage CHANGE balance balance VARCHAR(255) DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE reference reference VARCHAR(255) DEFAULT NULL, CHANGE confimre_at confimre_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE uuid uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE journal_caisse CHANGE date date DATETIME DEFAULT NULL, CHANGE num_piece num_piece VARCHAR(255) DEFAULT NULL, CHANGE intitule intitule VARCHAR(255) DEFAULT NULL, CHANGE entree entree VARCHAR(255) DEFAULT NULL, CHANGE sortie sortie VARCHAR(255) DEFAULT NULL, CHANGE solde solde VARCHAR(255) DEFAULT NULL, CHANGE uuid uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE recu_caisse CHANGE date date DATETIME DEFAULT NULL, CHANGE montant montant VARCHAR(255) DEFAULT NULL, CHANGE uuid uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE reference reference VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE beneficiaire beneficiaire VARCHAR(255) DEFAULT NULL');
