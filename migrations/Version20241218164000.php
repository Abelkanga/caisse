 ...
 */
final class Version20241218164000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail (id INT AUTO_INCREMENT NOT NULL, fdb_id INT DEFAULT NULL, depense_id INT DEFAULT NULL, designationproduit VARCHAR(255) NOT NULL, quantite INT NOT NULL, price INT NOT NULL, montant INT NOT NULL, INDEX IDX_2E067F93BF2BFC3 (fdb_id), INDEX IDX_2E067F9341D81563 (depense_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journal_caisse (id INT AUTO_INCREMENT NOT NULL, caisse_id INT DEFAULT NULL, fdb_id INT DEFAULT NULL, bonapprovisionnement_id INT DEFAULT NULL, recu_caisse_id INT DEFAULT NULL, bon_caisse_id INT DEFAULT NULL, appro_caisse_id INT DEFAULT NULL, order_mission_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, num_piece VARCHAR(255) DEFAULT NULL, intitule VARCHAR(255) DEFAULT NULL, entree VARCHAR(255) DEFAULT NULL, sortie VARCHAR(255) DEFAULT NULL, solde VARCHAR(255) DEFAULT NULL, uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_69FB412D27B4FEBF (caisse_id), INDEX IDX_69FB412DBF2BFC3 (fdb_id), INDEX IDX_69FB412D1715AECD (bonapprovisionnement_id), INDEX IDX_69FB412D907D10FF (recu_caisse_id), INDEX IDX_69FB412DB01D5004 (bon_caisse_id), INDEX IDX_69FB412DFE72186C (appro_caisse_id), INDEX IDX_69FB412DDB653C5 (order_mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_mission (id INT AUTO_INCREMENT NOT NULL, fdb_id INT DEFAULT NULL, caisse_id INT DEFAULT NULL, uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', date DATETIME NOT NULL, reference VARCHAR(255) NOT NULL, gerant VARCHAR(255) NOT NULL, date_depart DATETIME DEFAULT NULL, date_retour DATETIME DEFAULT NULL, fonction VARCHAR(255) DEFAULT NULL, service VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, beneficiaire VARCHAR(255) DEFAULT NULL, montant VARCHAR(255) DEFAULT NULL, order_to VARCHAR(255) DEFAULT NULL, get_to VARCHAR(255) DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, INDEX IDX_661D5B77BF2BFC3 (fdb_id), INDEX IDX_661D5B7727B4FEBF (caisse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE societe (id INT AUTO_INCREMENT NOT NULL, fonction_id INT DEFAULT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, forme_juridique TINYTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', activite VARCHAR(255) DEFAULT NULL, siege_sociale VARCHAR(255) DEFAULT NULL, adresse_postale VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, site_internet VARCHAR(255) DEFAULT NULL, code_commerce VARCHAR(255) DEFAULT NULL, numero_compte_contribuable VARCHAR(255) DEFAULT NULL, regime_fiscale VARCHAR(255) DEFAULT NULL, numero_tele_declarant VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, forme LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', siege_social VARCHAR(255) DEFAULT NULL, INDEX IDX_19653DBD57889920 (fonction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
