...
// */
//final class Version20240613135755 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE bonapprovisionnement ADD reference VARCHAR(255) DEFAULT NULL, CHANGE nature nature VARCHAR(255) NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE type_expense CHANGE code code VARCHAR(255) DEFAULT \'NULL\', CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE bonapprovisionnement DROP reference, CHANGE nature nature VARCHAR(255) DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
