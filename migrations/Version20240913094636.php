...
// */
//final class Version20240913094636 extends AbstractMigration
//{
...
//        $this->addSql('CREATE TABLE appro_caisse (id INT AUTO_INCREMENT NOT NULL, journee_id INT DEFAULT NULL, caisse_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, montant VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_C12B0312CF066148 (journee_id), INDEX IDX_C12B031227B4FEBF (caisse_id), INDEX IDX_C12B0312A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
