 ...
 */
final class Version20250210171119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE back_cash (id INT AUTO_INCREMENT NOT NULL, caisse_id INT DEFAULT NULL, user_id INT DEFAULT NULL, bon_mission_id INT DEFAULT NULL, bon_caisse_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, montant INT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, montant_retour INT DEFAULT NULL, type_depense VARCHAR(255) DEFAULT NULL, reference_depense VARCHAR(255) DEFAULT NULL, INDEX IDX_CD0ED6F727B4FEBF (caisse_id), INDEX IDX_CD0ED6F7A76ED395 (user_id), INDEX IDX_CD0ED6F7E2486D3A (bon_mission_id), INDEX IDX_CD0ED6F7B01D5004 (bon_caisse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE bon_mission (id INT AUTO_INCREMENT NOT NULL, order_mission_id INT DEFAULT NULL, caisse_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, city_id INT DEFAULT NULL, user_id INT DEFAULT NULL, valid_by_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, montant VARCHAR(255) DEFAULT NULL, uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', reference VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, beneficiaire VARCHAR(255) DEFAULT NULL, total NUMERIC(10, 2) DEFAULT NULL, INDEX IDX_567F57F6DB653C5 (order_mission_id), INDEX IDX_567F57F627B4FEBF (caisse_id), INDEX IDX_567F57F6F347EFB (produit_id), INDEX IDX_567F57F68BAC62AF (city_id), INDEX IDX_567F57F6A76ED395 (user_id), INDEX IDX_567F57F6D8228AFF (valid_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, bp VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE detail (id INT AUTO_INCREMENT NOT NULL, fdb_id INT NOT NULL, depense_id INT DEFAULT NULL, designationproduit VARCHAR(255) NOT NULL, quantite INT NOT NULL, price INT NOT NULL, montant INT NOT NULL, INDEX IDX_2E067F93BF2BFC3 (fdb_id), INDEX IDX_2E067F9341D81563 (depense_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE detail_bon_mission (id INT AUTO_INCREMENT NOT NULL, order_mission_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, bon_mission_id INT NOT NULL, city_id INT DEFAULT NULL, rubrique VARCHAR(255) DEFAULT NULL, quantite INT NOT NULL, price INT NOT NULL, montant INT NOT NULL, ville VARCHAR(255) DEFAULT NULL, INDEX IDX_39743AA7DB653C5 (order_mission_id), INDEX IDX_39743AA7F347EFB (produit_id), INDEX IDX_39743AA7E2486D3A (bon_mission_id), INDEX IDX_39743AA78BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE detail_mission (id INT AUTO_INCREMENT NOT NULL, order_mission_id INT NOT NULL, full_name VARCHAR(255) DEFAULT NULL, fonction VARCHAR(255) DEFAULT NULL, service VARCHAR(255) DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, INDEX IDX_F7A872E9DB653C5 (order_mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journal_caisse (id INT AUTO_INCREMENT NOT NULL, caisse_id INT DEFAULT NULL, fdb_id INT DEFAULT NULL, bonapprovisionnement_id INT DEFAULT NULL, recu_caisse_id INT DEFAULT NULL, bon_caisse_id INT DEFAULT NULL, appro_caisse_id INT DEFAULT NULL, order_mission_id INT DEFAULT NULL, bon_mission_id INT DEFAULT NULL, detail_id INT DEFAULT NULL, back_clash_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, num_piece VARCHAR(255) DEFAULT NULL, intitule VARCHAR(255) DEFAULT NULL, entree VARCHAR(255) DEFAULT NULL, sortie VARCHAR(255) DEFAULT NULL, solde VARCHAR(255) DEFAULT NULL, uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', libell�e VARCHAR(255) DEFAULT NULL, INDEX IDX_69FB412D27B4FEBF (caisse_id), INDEX IDX_69FB412DBF2BFC3 (fdb_id), INDEX IDX_69FB412D1715AECD (bonapprovisionnement_id), INDEX IDX_69FB412D907D10FF (recu_caisse_id), INDEX IDX_69FB412DB01D5004 (bon_caisse_id), INDEX IDX_69FB412DFE72186C (appro_caisse_id), INDEX IDX_69FB412DDB653C5 (order_mission_id), INDEX IDX_69FB412DE2486D3A (bon_mission_id), INDEX IDX_69FB412DD8D003BB (detail_id), INDEX IDX_69FB412D97CC8C0E (back_clash_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, fdb_id INT DEFAULT NULL, bonapprovisionnement_id INT DEFAULT NULL, approcaisse_id INT DEFAULT NULL, bon_mission_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, message VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', unread TINYINT(1) DEFAULT NULL, permission VARCHAR(255) DEFAULT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), INDEX IDX_BF5476CABF2BFC3 (fdb_id), INDEX IDX_BF5476CA1715AECD (bonapprovisionnement_id), INDEX IDX_BF5476CA19C8B436 (approcaisse_id), INDEX IDX_BF5476CAE2486D3A (bon_mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bon_mission ADD CONSTRAINT FK_567F57F6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
