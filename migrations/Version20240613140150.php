...
// */
//final class Version20240613140150 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE bonapprovisionnement ADD nature VARCHAR(255) NOT NULL');
...
//        $this->addSql('ALTER TABLE bonapprovisionnement DROP nature');
//    }
//}
