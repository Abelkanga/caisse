...
// */
//final class Version20240624094815 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE billetage ADD bonapprovisionnement_id INT DEFAULT NULL, CHANGE balance balance VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE bon_caisse CHANGE uuid uuid VARCHAR(255) DEFAULT NULL, CHANGE reference reference VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE beneficiaire beneficiaire VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL');
//        $this->addSql('ALTER TABLE bonapprovisionnement CHANGE reference reference VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE depense CHANGE date date DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE total total NUMERIC(10, 2) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE billetage DROP bonapprovisionnement_id, CHANGE balance balance VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE journee CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\', CHANGE close_at close_at DATETIME DEFAULT \'NULL\', CHANGE debit debit NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE credit credit NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE solde solde NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE last_solde last_solde NUMERIC(10, 2) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
//        $this->addSql('ALTER TABLE caisse CHANGE responsable responsable VARCHAR(255) DEFAULT \'NULL\', CHANGE soldedispo soldedispo NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE code code VARCHAR(255) DEFAULT \'NULL\'');
...
//        $this->addSql('ALTER TABLE user CHANGE contact contact VARCHAR(255) DEFAULT \'NULL\', CHANGE pseudo pseudo VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE type_expense CHANGE code code VARCHAR(255) DEFAULT \'NULL\', CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE bonapprovisionnement CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE reference reference VARCHAR(255) DEFAULT \'NULL\'');
