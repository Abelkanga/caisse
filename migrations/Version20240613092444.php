 ...
 */
final class Version20240613092444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bonapprovisionnement CHANGE updated_at updated_at DATETIME DEFAULT NULL');
