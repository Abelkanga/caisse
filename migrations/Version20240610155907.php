...
// */
//final class Version20240610155907 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE depense DROP date, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE total total NUMERIC(10, 2) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE fdb CHANGE date date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', CHANGE objet objet VARCHAR(255) NOT NULL, CHANGE departement departement VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE total total NUMERIC(10, 2) DEFAULT NULL, CHANGE beneficiaire beneficiaire VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE contact contact VARCHAR(255) DEFAULT NULL, CHANGE pseudo pseudo VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
//        $this->addSql('ALTER TABLE caisse CHANGE responsable responsable VARCHAR(255) DEFAULT \'NULL\', CHANGE soldedispo soldedispo NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE code code VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE fdb CHANGE date date DATE DEFAULT \'NULL\' COMMENT \'(DC2Type:date_immutable)\', CHANGE objet objet VARCHAR(255) DEFAULT \'NULL\', CHANGE departement departement VARCHAR(255) DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE total total NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE beneficiaire beneficiaire VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin` COMMENT \'(DC2Type:json)\', CHANGE contact contact VARCHAR(255) DEFAULT \'NULL\', CHANGE pseudo pseudo VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE type_expense CHANGE code code VARCHAR(255) DEFAULT \'NULL\', CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
...
//        $this->addSql('ALTER TABLE depense ADD date DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE total total NUMERIC(10, 2) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE expense CHANGE code code VARCHAR(255) DEFAULT \'NULL\', CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE bon_caisse CHANGE uuid uuid VARCHAR(255) DEFAULT \'NULL\', CHANGE reference reference VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
//        $this->addSql('ALTER TABLE emeteur CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE contact contact VARCHAR(255) DEFAULT \'NULL\'');
//    }
