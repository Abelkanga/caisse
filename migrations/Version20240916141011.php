...
// */
//final class Version20240916141011 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE appro_caisse ADD caisse_emettrice_id INT NOT NULL, ADD caisse_receptrice_id INT NOT NULL, CHANGE status status VARCHAR(255) NOT NULL, CHANGE uuid uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
...
//        $this->addSql('ALTER TABLE appro_caisse DROP caisse_emettrice_id, DROP caisse_receptrice_id, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE uuid uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
//    }
//}
