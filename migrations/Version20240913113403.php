...
// */
//final class Version20240913113403 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE appro_caisse ADD uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
...
//        $this->addSql('ALTER TABLE appro_caisse DROP uuid');
//    }
//}
