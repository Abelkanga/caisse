 ...
 */
final class Version20250211211405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bon_mission (id INT AUTO_INCREMENT NOT NULL, order_mission_id INT DEFAULT NULL, caisse_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, user_id INT DEFAULT NULL, valid_by_id INT DEFAULT NULL, ville_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, montant VARCHAR(255) DEFAULT NULL, uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', reference VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, beneficiaire VARCHAR(255) DEFAULT NULL, total NUMERIC(10, 2) DEFAULT NULL, INDEX IDX_567F57F6DB653C5 (order_mission_id), INDEX IDX_567F57F627B4FEBF (caisse_id), INDEX IDX_567F57F6F347EFB (produit_id), INDEX IDX_567F57F6A76ED395 (user_id), INDEX IDX_567F57F6D8228AFF (valid_by_id), INDEX IDX_567F57F6A73F0036 (ville_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE detail_bon_mission (id INT AUTO_INCREMENT NOT NULL, order_mission_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, bon_mission_id INT NOT NULL, rubrique VARCHAR(255) DEFAULT NULL, quantite INT NOT NULL, price INT NOT NULL, montant INT NOT NULL, ville VARCHAR(255) DEFAULT NULL, INDEX IDX_39743AA7DB653C5 (order_mission_id), INDEX IDX_39743AA7F347EFB (produit_id), INDEX IDX_39743AA7E2486D3A (bon_mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
