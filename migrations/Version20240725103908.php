...
// */
//final class Version20240725103908 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE billetage ADD journee_id INT DEFAULT NULL');
//        $this->addSql('ALTER TABLE billetage ADD CONSTRAINT FK_83E6E9FACF066148 FOREIGN KEY (journee_id) REFERENCES journee (id)');
//        $this->addSql('CREATE UNIQUE INDEX UNIQ_83E6E9FACF066148 ON billetage (journee_id)');
...
//        $this->addSql('DROP INDEX UNIQ_83E6E9FACF066148 ON billetage');
//        $this->addSql('ALTER TABLE billetage DROP journee_id');
//        $this->addSql('ALTER TABLE societe CHANGE forme_juridique forme_juridique JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
