...
// */
//final class Version20240916160722 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE journal_caisse ADD appro_caisse_id INT DEFAULT NULL');
...
//        $this->addSql('CREATE INDEX IDX_69FB412DFE72186C ON journal_caisse (appro_caisse_id)');
...
//        $this->addSql('DROP INDEX IDX_69FB412DFE72186C ON journal_caisse');
//        $this->addSql('ALTER TABLE journal_caisse DROP appro_caisse_id');
